...
<body>
	...
	<main><br>
	<article><pre>
 <img src="images/logo.png" alt="Logo" width="80" height="85" />       

<h1>Privacy Policy for LankaProperty</h1>

At LankaProperty, accessible from www.LankaProperty.lk, one of our main priorities is the privacy of our visitors. This Privacy Policy document 
contains types of information that is collected and recorded by LankaProperty and how we use it.

If you have additional questions or require more information about our Privacy Policy, do not
hesitate to contact us.

This Privacy Policy applies only to our online activities and is valid for visitors to our website 
with regards to the information that they shared and/or collect in LankaProperty. This policy is not
...
LankaProperty follows a standard procedure of using log files. These files log visitors when they 
...
Like any other website, LankaProperty uses 'cookies'. These cookies are used to store information 
...
Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies,
 ...
 on the internet. However, visitors may choose to decline the use of DART cookies by visiting 
...
Beacons that are used in their respective advertisements and links that appear on LankaProperty,
...
Note that LankaProperty has no access to or control over these cookies that are used by
 third-party advertisers.
Third Party Privacy Policies

LankaProperty's Privacy Policy does not apply to other advertisers or websites. Thus, we are 
...
LankaProperty does not knowingly collect any Personal Identifiable Information from children under 
the age of 13. If you think that your child provided this kind of information on our website, 
we strongly encourage you to contact us immediately and we will do our best efforts to promptly
 remove such information from our records</pre></article>
</main>
