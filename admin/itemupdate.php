...
if(count($_POST)>0) {
mysqli_query($con,"UPDATE users set user_name='" . $_POST['user_name'] . "', password='" . $_POST['password'] . "', email='" . $_POST['email'] . "' ,full_name='" . $_POST['full_name'] . "' WHERE id='" . $_POST['id'] . "'");
$message = "Record Modified Successfully";
}
$result = mysqli_query($con,"SELECT * FROM item WHERE item_id = '" . $_GET['id'] . "'");
