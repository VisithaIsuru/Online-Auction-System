 ...
 <div class="container-fluid" style="width:90%;">
  ...
  ?>
    <div class="product-item" style="background:#fff;">
      ...
      <div><strong>Name:<?php echo $product_array[$key]["name"]; ?></strong></div>
      

      <div class="product-price"><?php echo $product_array[$key]["price"]. "Rs"; ?></div>
      <div><input type="submit" value="Add to Watch list" class="btn btn-primary" style="width:70%;border-radius:360px;" /></div>
      </form>
    </div>
  <?php
      }
